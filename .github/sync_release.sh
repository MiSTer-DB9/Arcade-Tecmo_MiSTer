...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Tecmo_MiSTer.git"
CORE_NAME=(Arcade-Tecmo)
...
UPSTREAM_CORE_NAME=(Arcade-Tecmo)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Tecmo.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Tecmo.rbf)
